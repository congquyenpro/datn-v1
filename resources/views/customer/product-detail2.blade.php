						...
						<div class="details-infor">
							...
							<div class="variations">
								...
								<div class="attribute attribute_size">
									...
									<div class="list-size list-item">
										@php
											$sizes = $product->productSizes ?? []; // Use the correct relation name
											$selectedSize = !empty($sizes) ? $sizes->first()->volume : null; // Get the volume of the first size
										@endphp
								
										@if (is_iterable($sizes) && count($sizes) > 0)
											@foreach ($sizes as $size)
												<a href="#" class="{{ $size->volume == $selectedSize ? 'active' : '' }}"  data-size-id="{{ $size->id}}"  data-size-price="{{ $size->price }}" >{{ $size->volume }} ml</a>
											@endforeach
										@else
							...
							<div class="group-button">
								...
								<div class="quantity-add-to-cart">
									...
									<button class="single_add_to_cart_button button2">Add to cart</button>
								</div>
							</div>
						</div>
					</div>
